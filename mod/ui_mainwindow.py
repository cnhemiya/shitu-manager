...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.imageZoomOutInHSlider = QtWidgets.QSlider(self.layoutWidget1)
        self.imageZoomOutInHSlider.setMaximumSize(QtCore.QSize(400, 16777215))
        self.imageZoomOutInHSlider.setMinimum(1)
        self.imageZoomOutInHSlider.setMaximum(10)
        self.imageZoomOutInHSlider.setPageStep(2)
